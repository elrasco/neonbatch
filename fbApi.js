...
const login = (fb_exchange_token) => Graph
...
const asBatchRequests = (calls, mapResponseFunction, access_token) => Graph
  .api(`/`, 'POST', { include_headers: false, batch: calls, access_token })
